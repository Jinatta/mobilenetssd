...
lineaccesstoken = 'eEKAecCL3kt1AReMEUFtZySADEx2UvOt9xfLlDJNgjNtBHV43cKWJ93EizuF7krndZYdPHTkWgen2LM94/m6hfHU6ro8dbB8IuPR+vdjuZr1MR8Lr5XbEPLbE2CQwxr46A6GrctWPVizsQZnEAkQwwdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            replyObj = TextSendMessage(text="ไม่เที่ยวหรอก")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ไปก่อนนะ") :
            replyObj = TextSendMessage(text="จ้า")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ทำอะไรอยู่") :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/fbaa4ce4-959f-48c0-8c91-f7fc9899b951"
